...
#define LV_DRAW_LAYER_SIMPLE_BUF_SIZE    (20 * 1024)    /**< [bytes]*/
 ...
 */
#define LV_DRAW_THREAD_STACK_SIZE    (6 * 1024)         /**< [bytes]*/
...
#define LV_USE_LOG 1
    ...
    #define LV_LOG_PRINT_CB lvgl_log_print
